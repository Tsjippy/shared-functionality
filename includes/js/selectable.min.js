  ...
  function () {
    ...
    var I = "classList" in document.documentElement,
      k = {
        add: function (a, c) {
          I
            ? a.classList.add(c)
            : k.contains(a, c) || (a.className = a.className.trim() + " " + c);
        },
        remove: function (a, c) {
          I
    ...
    J.prototype = {
      ...
      setContainer: function (a) {
        ...
        k.add(this.container, c.classes.container);
        this.container._selectable = this;
        b && (k.remove(b, c.classes.container), delete b._selectable);
      ...
      deselect: function (a, c) {
        ...
        if ((a = this.get(a))) {
          ...
          a.deselecting = !1;
          a.startselected = !1;
          k.remove(b, d.deselecting);
          k.remove(b, d.selecting);
          k.remove(b, d.selected);
          c && this.config.saveState && this.state("save");
          this.emit(
      ...
      add: function (a) {
        ...
        for (var b = 0; b < a.length; b++)
          0 > this.nodes.indexOf(a[b]) &&
            ...
            (c.push(a[b]), k.add(a[b], this.config.classes.selectable));
      ...
      getUnSelectedNodes: function () {
        return this.getUnSelectedItems().map(function (a) {
          return a.node;
        });
      },
      state: function (a) {
      ...
      enable: function () {
        if (!this.enabled) {
          ...
          this.bind();
          k.add(this.container, this.config.classes.container);
      ...
      disable: function () {
        this.enabled &&
          ((this.enabled = !1),
          this.unbind(),
          k.remove(this.container, this.config.classes.container),
      ...
      _start: function (a) {
        var c = this,
          ...
          d = this.config,
          e,
          l = y(a) && (this.canCtrl || this.canMeta),
          m = this.canShift && !!a.shiftKey,
          h = this.getSelectedItems().length,
          g = d.maxSelectable;
        if (g && h >= g && (l || m)) return this._maxReached();
        if (
          !(
          ...
          g = w(a.target, function (n) {
            return n === c.container || k.contains(n, d.classes.selectable);
          });
          if (!g) return !1;
          -1 ===
          ...
          g !== this.container
            ? ((b = this.get(g)),
              (b.selecting = !0),
              k.add(g, d.classes.selecting))
            : "sequential" == d.lassoSelect && (g = G(b, this.items));
          d.autoRefresh && this.refresh();
          if (m && this.startEl && g !== this.container)
            if (
              ((b = this.getItems()),
              (f = this.getNodes().indexOf(g)),
              (h = this.getNodes().indexOf(this.getFirstSelectedNode())),
              f > h)
            )
              for (h += 1; h < f; h++) b[h].selecting = !0;
            else for (--h; h > f; h--) b[h].selecting = !0;
          for (h = 0; h < this.items.length; h++) {
            ...
            b.selected &&
              ((b.startselected = !0),
              (d.toggle || l ? !u : u || m) ||
                (k.remove(f, d.classes.selected),
                (b.selected = !1),
                k.add(f, d.classes.deselecting),
                (b.deselecting = !0)));
            u && (e = b);
          }
          this.startEl = g;
      ...
      _drag: function (a) {
        ...
        if (!(c.disabled || !this.dragging || (a.shiftKey && this.canShift))) {
          ...
          for (var d = 0; d < z.length; d++) {
            var e = z[d];
            if (this.current[t[e]] > this.current[A[e]]) {
              var l = this.current[A[e]];
              this.current[A[e]] = this.current[t[e]];
              this.current[t[e]] = l;
            }
          }
          this.coords = {
      ...
      _end: function (a) {
        if (this.dragging) {
          ...
          this.lasso &&
            ...
            b || (b = this.container));
          b = w(b, function (u) {
            return k.contains(u, c.classes.selectable);
          });
          d = !1;
          for (var g = 0; g < this.items.length; g++) {
            ...
            f.deselecting && (l.push(f), this.deselect(f, !1));
            f.selecting &&
              (h && m + e.length >= h
                ? ((f.selecting = !1),
                  k.remove(f.node, c.classes.selecting),
                  (d = !0))
                : (e.push(f), this.select(f, !1, !1)));
          }
          c.saveState && this.state("save");
          this.emit(15 > this.v[1] ? "selectable.end" : "end", a, e, l);
      ...
      _loadItems: function () {
        ...
        if (this.nodes.length)
          for (var b = 0; b < this.nodes.length; b++) {
            var d = this.nodes[b];
            k.add(d, c.classes.selectable);
            var e = {
                node: d,
                rect: F(d),
                startselected: !1,
                selected: k.contains(d, c.classes.selected),
                selecting: k.contains(d, c.classes.selecting),
                deselecting: k.contains(d, c.classes.deselecting),
              },
              l = this._get2DTransformation(d);
            if (l) {
              var m = d;
              var h = (a = 0);
              do
              ...
              for (d = 0; 3 >= d; d++) {
                ...
                v = (v * Math.PI) / 180;
                p[n] = {
                  x: Math.cos(v) * (q - B) - Math.sin(v) * (D - r) + B,
                  y: Math.sin(v) * (q - B) + Math.cos(v) * (D - r) + r,
                };
              }
              e.transform = { rect: f };
            }
      ...
      _autoScroll: function () {
        ...
        for (var d = 0; d < z.length; d++) {
          ...
          this.scroll[e] < this.scroll.max[e]
            ? (b[e] = c)
            : this.mouse[e] <= this.boundingRect[t[e]] + a &&
              0 < this.scroll[e] &&
              (b[e] = -c);
        }
        this.bodyContainer
      ...
      _limitLasso: function () {
        for (var a = 0; a < z.length; a++) {
          var c = z[a],
            b = this.boundingRect[t[c]] + this.scroll.size[c];
          if (this.mouse[c] >= b && this.scroll[c] >= this.scroll.max[c]) {
            var d = this.origin[c] - this.boundingRect[t[c]] - this.scroll[c];
            this.coords[t[c]] = this.origin[c] - this.boundingRect[t[c]];
            this.coords[A[c]] = b - d - this.boundingRect[t[c]];
          }
          this.mouse[c] <= this.boundingRect[t[c]] &&
            0 >= this.scroll[c] &&
            ((this.coords[t[c]] = 0),
            (this.coords[A[c]] = this.origin[c] - this.boundingRect[t[c]]));
        }
      },
      _sequentialSelect: function (a) {
        ...
        if (b && (b = b.closest("." + c.selectable))) {
          ...
          for (b = 0; b < this.items.length; b++) {
            var l = this.items[b];
            b >= d && b <= e
              ? this._highlight(l, y(a) && (this.canCtrl || this.canMeta))
              : ((l.selecting = !1), l.node.classList.remove(c.selecting));
          }
        }
      },
      _highlight: function (a, c, b) {
        ...
        var d = a.node,
          e = !1,
          l = this.bodyContainer ? 0 : this.scroll.x,
        ...
        if ("normal" === b.lassoSelect)
          if ("touch" === b.tolerance)
            if (a.transform)
              a: {
                ((e = [
                  ...
                  { x: this.mouse.x + l, y: this.origin.y },
                  { x: this.mouse.x + l, y: this.mouse.y + m },
                ...
                for (m = 0; m < u.length; m++) {
                  ...
                  for (h = 0; h < n.length; h++) {
                    var q = n[h];
                    var p = n[(h + 1) % n.length];
                    var D = p.y - q.y,
                      B = q.x - p.x;
                    q = p = void 0;
                    for (g = 0; g < e.length; g++) {
                      var r = D * e[g].x + B * e[g].y;
                      (void 0 === q || r < q) && (q = r);
                      (void 0 === p || p < r) && (p = r);
                    }
                    var v = (f = void 0);
              ...
              e = !(
                a.rect.x1 + l > this.current.x2 ||
                a.rect.x2 + l < this.current.x1 ||
            ...
            "fit" === b.tolerance &&
              (e =
                a.rect.x1 + l > this.current.x1 &&
                a.rect.x2 + l < this.current.x2 &&
        ...
        e
          ? (a.selected &&
              !b.toggle &&
              (k.remove(d, b.classes.selected), (a.selected = !1)),
            a.deselecting &&
              (!b.toggle || (b.toggle && "drag" !== b.toggle)) &&
              (k.remove(d, b.classes.deselecting), (a.deselecting = !1)),
            a.selecting || (k.add(d, b.classes.selecting), (a.selecting = !0)))
          : (a.selecting &&
              (k.remove(d, b.classes.selecting),
              (a.selecting = !1),
              c && a.startselected
                ? (k.add(d, b.classes.selected), (a.selected = !0))
                : a.startselected &&
                  !b.toggle &&
                  (k.add(d, b.classes.deselecting), (a.deselecting = !0))),
            !a.selected ||
              c ||
              a.startselected ||
              (k.remove(d, b.classes.selected),
              (a.selected = !1),
              k.add(d, b.classes.deselecting),
              (a.deselecting = !0)));
      },
      _focus: function (a) {
        this.focused = !0;
        k.add(this.container, "ui-focused");
      },
      _blur: function (a) {
        this.focused = !1;
        k.remove(this.container, "ui-focused");
      },
      _get2DTransformation: function (a) {
        ...
        if (c && "none" !== c) {
          ...
          var b = parseFloat(c[0]),
            d = parseFloat(c[1]),
            e = Math.sqrt(b * b + d * d);
          a = a.transformOrigin.split(" ").map(function (l) {
            return parseFloat(l);
          });
          return {
